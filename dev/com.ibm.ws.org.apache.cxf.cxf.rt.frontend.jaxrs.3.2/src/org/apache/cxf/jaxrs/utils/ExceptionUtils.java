...
try { //jim
        if (response == null) {
            ...
            if (mapper != null) {
                try {
                    System.out.println("Jim...ExceptionUtils.cftr: mapper = " + mapper.getClass().getName());
    ...
    System.out.println("Jim... ExceptionUtils.cftr: caught throwable: " + t);
    t.printStackTrace();
    throw t;
}
System.out.println("Jim... ExceptionUtils.cftr: returning response : " + response);
System.out.println("Jim... ExceptionUtils.cftr: returning ");
